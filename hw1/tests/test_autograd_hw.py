...
#     gradient_check(ndl.log, ndl.Tensor(np.abs(np.random.randn(5,4))), tol=1e-1)
#     gradient_check(ndl.log, ndl.Tensor(np.abs(np.random.randn(5,4,3))), tol=1e-1)
#     gradient_check(ndl.log, ndl.Tensor(np.abs(np.random.randn(5,4,3,2))), tol=1e-1)


def test_exp_backward():
    gradient_check(ndl.exp, ndl.Tensor(np.random.randn(5,4)))
    gradient_check(ndl.exp, ndl.Tensor(np.random.randn(5,4,3)))
    gradient_check(ndl.exp, ndl.Tensor(np.random.randn(5,4,3,2)))


def test_relu_backward():
    gradient_check(ndl.relu, ndl.Tensor(np.random.randn(5,4)))
    gradient_check(ndl.relu, ndl.Tensor(np.random.randn(5,4,3)))
    gradient_check(ndl.relu, ndl.Tensor(np.random.randn(5,4,3,2)))
